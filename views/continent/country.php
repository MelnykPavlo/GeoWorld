...
$this->params['breadcrumbs'][]=['label'=>$country['name'], 'url'=>['continent/country', "code" => $country['code']]];
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-6">
                ...
                <a href="<?= URL::to(['/country/edit/'. $country['country_id']])?>"
                   style="text-decoration: none!important; display:block; background-color: red; color: white; width: 100px; text-align: center"> Edit</a>
            </div>
            <div class="col-6">
